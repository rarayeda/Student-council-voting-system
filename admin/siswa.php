...
<body>
  ...
  <div class="content">
    <h2 style="font-family: sans-serif;">Data siswa</h2>
    <?php include("upload-data_siswa.php") ?>
    <button id="tampilkanModal" class="btn" style="margin-left:760px; margin-bottom:15px;">Tambah data siswa</button>
      ...
      <tbody>
        ...
        foreach ($tampil as $t) {
          echo "
                                  ...
                                  <td>$t->memilih</td>
                                  <td>
                                      <a href='edit_siswa.php?id=$t->id' style='padding:2px; text-decoration: none; background-color: green; color:black; border: green; border-radius: 5px;'>Edit</a>
                                       <form action='hapus_siswa.php' method='post' style='display: inline;'>
                                        <input type='hidden' name='id' value='$t->id'/>
                                        <input type='submit' name='hapus-data' value='Hapus'  onclick='return konfirmasiHapus();' style='background-color:red;  border-radius: 5px;'/>
                                       </form> 
                                  </td>
                                  </tr>
                                    ";
